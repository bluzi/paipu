const resolveHandlers = async (transform, handlers) => {
...
class Paipu {
    ...
    async resolve(context) {
        ...
        for (const { transform, alias } of this.transforms) {
            ...
            await resolveHandlers(alias || index, this.beforePipeHanlders);
            ...
            await resolveHandlers(alias || index, this.afterPipeHanlders);
            index++;
        }
